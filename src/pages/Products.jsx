...
const Products = () => {
  const smokePanels = [
    ...
    { title: "Smoke damper and actuator", img: "https://airmasteremirates.com/wp-content/uploads/2016/02/Motorized-Smoke-Damper.jpg" },
    ...
    { title: "Fire Alarm Control Panel", img: "https://5.imimg.com/data5/SELLER/Default/2021/7/RQ/WQ/GU/35675385/fire-alarm-control-panel.jpg" },
  ...
  const emsInstruments = [
    ...
    { title: "Velocity sensor", img: "https://encrypted-tbn3.gstatic.com/shopping?q=tbn:ANd9GcTGZyaHzVLWO0FhSZUDewgO4THeWIAgA6-OKooBIt1P-8-B8TFlPb0tD3zq0taFElOMNu_4dDg0vkQXTdtvh9GXM5bofErvMP2kQOVIJ4dAw-QXrmemO3HDRg" },
    ...
    { title: "Room Air static pressure sensor", img: "https://www.sensorsone.com/wp-content/uploads/2013/10/DPS200.jpg" },
